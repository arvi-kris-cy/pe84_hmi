...
#define CY_NON_CACHABLE_SOCMEM_SHARED_ADDR (CYMEM_CM55_0_m33_m55_shared_START)
#define CY_NON_CACHABLE_SOCMEM_SHARED_SIZE (CYMEM_CM55_0_m33_m55_shared_SIZE)

#define CY_NON_CACHABLE_GPU_BUF_ADDR       (CYMEM_CM55_0_gfx_mem_START)
#define CY_NON_CACHABLE_GPU_BUF_SIZE       (CYMEM_CM55_0_gfx_mem_SIZE)
