...
const cyhal_spi_configurator_t CYBSP_SPI_CONTROLLER_10_hal_config =
{
    ...
    .gpios = {.sclk = P16_0, .ssel = {P16_3, NC, NC, NC}, .mosi = P16_1, .miso = P16_2},
};
#endif /* defined (CY_USING_HAL) || defined(CY_USING_HAL_LITE) */
...
const cy_stc_scb_ezi2c_config_t CYBSP_EZ_I2C_TARGET_5_config =
{
...
#if defined (CY_USING_HAL)
const cyhal_resource_inst_t CYBSP_EZ_I2C_TARGET_5_obj =
{
    .type = CYHAL_RSC_SCB,
    .block_num = 5U,
    .channel_num = 0U,
};
const cyhal_clock_t CYBSP_EZ_I2C_TARGET_5_clock =
{
    .block = CYHAL_CLOCK_BLOCK0_PERIPHERAL1_8BIT,
    .channel = 0,
    .reserved = false,
...
const cyhal_ezi2c_configurator_t CYBSP_EZ_I2C_TARGET_5_hal_config =
{
    .resource = &CYBSP_EZ_I2C_TARGET_5_obj,
    .config = &CYBSP_EZ_I2C_TARGET_5_config,
    .clock = &CYBSP_EZ_I2C_TARGET_5_clock,
};
#endif /* defined (CY_USING_HAL) */
...
void reserve_cycfg_peripherals(void)
{
    ...
    cyhal_hwmgr_reserve(&CYBSP_EZ_I2C_TARGET_5_obj);
