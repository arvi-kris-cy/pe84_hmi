/******************************************************************************
* File Name : tune_inferencing_mains.c
*
* Description :
* Source file for Inference processing on CM55. (mains powered Tuning)
********************************************************************************
...
/*******************************************************************************
* Function Name: tune_mains_inference_engine_init
********************************************************************************
* Summary:
* Initializes inferencing library for tuning.
*
* Parameters:
*  None
*
...
void tune_mains_inference_engine_init()
{
