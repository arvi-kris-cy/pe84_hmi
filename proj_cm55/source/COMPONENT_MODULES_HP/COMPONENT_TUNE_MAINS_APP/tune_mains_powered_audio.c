/******************************************************************************
* File Name : tune_mains_powered_audio.c
*
* Description :
* Audio application for CM55 core (mains powered use-case tuning).
********************************************************************************
...
/*******************************************************************************
* Function Name: tune_mains_powered_audio
********************************************************************************
* Summary:
* Initialize CM55 audio application for mains powered use-case -(USB/PDM tuning).
*
* Parameters:
*  None
*
...
void tune_mains_powered_audio()
{
    ...
    tune_mains_afe_mw_init();
    
    create_mains_powered_control_task();

    tune_mains_inference_engine_init();
