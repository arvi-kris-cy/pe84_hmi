...
#if defined(ENABLE_PUSH_TO_TALK)
...
#endif
{
    ...
    printf("AM memory presistent size %d \r\n",am_mem_info.persistent_mem);
    ...
    printf("Feature info scratch mem %d \r\n",scrtach_sz);
